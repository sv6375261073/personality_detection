...
class Predictor_cat5():
    ...
    def predict(self, X, traits='All', predictions='All'):
        ...
        return predictions,trait_categories_probs
...
class mbti_models:
    ...
    def predict(self,text):
        categories=[('Introversion','Extroversion'),('Intuition','Sensing'),('Thinking','Feeling'),('Judging','Perceiving')]
        ...
        return self.prediction,self.probablity
